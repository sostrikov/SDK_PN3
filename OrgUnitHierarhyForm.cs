...
{
    public class OrgUnitHierarhyForm : Form
    {
        public OrgUnitHierarhyForm()
        {
            InitializeComponent();
        }
        ...
        public OrgUnit SelectedOrgUnit
        {
            get
            {
                if (tvHierarhy.SelectedNode == null)
                    return null;
                return tvHierarhy.SelectedNode.Tag as OrgUnit;
            }
        }
        ...
        private void ShowHierarhy()
        {
            try
            {
                ...
                OrgUnit[] hierarhyList = integServ.GetOrgUnitsHierarhy(ClientState.SessionID);
                ClientState.SetOrgUnitHierarhy(hierarhyList);
                try
                {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OrgUnitHierarhyForm));
            ...
            this.btnCancel.Location = new System.Drawing.Point(485, 434);
            ...
            this.btnOk.Location = new System.Drawing.Point(404, 434);
            ...
            this.tvHierarhy.Size = new System.Drawing.Size(560, 428);
